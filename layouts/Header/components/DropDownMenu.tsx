    ...
    <>
      ...
      >
        {data.name === "Change" ? (
          ...
          <span onMouseEnter={handleToggle} onMouseLeave={handleClosePopper}>
            {data.name}
            <ExpandMoreIcon
              style={{
                marginLeft: "6px",
          ...
          >
            <Paper className={classes.downMenuBox}>
              <ClickAwayListener onClickAway={handleClose}>
                ...
                >
                  {data.children.map((child: any, key: number) => {
                    if (
                      child.name === "VLX Mainnet" ||
                      child.name === "VLX Testnet"
                    ) {
                      return (
                        <a
                          key={key}
                      ...
                      return (
                        <MenuItem className={classes.menuList} key={key}>
                          <Button
                            key={key}
