...
function EmailForm() {
  ...
  const handleSubmit = async (
    ...
    if (email.length === 0) {
      setEmailValid('Please input your email.')
      isValid = false
    }

    if (password.length === 0) {
      setPasswordValid('Please input your password.')
      isValid = false
    }

    if (confirm.length === 0) {
      setConfirmValid('Please input your confirm password.')
      isValid = false
    }
