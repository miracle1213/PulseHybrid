...
function PhoneForm() {
  ...
  useEffect(() => {
    if (
      (password.length < 7 || upperCnt === 0 || numberCnt === 0) &&
      password.length > 0
    ) {
      setPasswordValid(
  ...
  const handleNameChange = (value: any) => {
    ...
    if (name.length > 0) {
      ...
      setNameValid('Name field is required')
    }
  }
  ...
  const [flag, setFlag] = useState(
    'https://cdn.kcak11.com/CountryFlags/countries/us.svg',
  )
  ...
  const handleRegisterSubmit = async (
    ...
    if (name.length === 0) {
      setNameValid('Please input your full name')
      isValid = false
    }

    if (phoneNum.length === 0) {
      setPhoneNumValid('Please input your phone number')
      isValid = false
    }
    ...
    <>
      <form onSubmit={handleRegisterSubmit}>
        <FormControl className={classes.formControlSide} variant="outlined">
          <FormHelperText
            className={clsx(classes.fontColor1, classes.helperText)}
          >
            Full Name
          </FormHelperText>
          <ClickAwayListener onClickAway={() => setClickName(false)}>
            <div
              className={clsx({
                [classes.inputSide]: nameValid === '',
                [classes.inputSide3]: nameValid === '' && clickName === true,
                [classes.inputSide2]: nameValid !== '',
              })}
            >
              <input
                value={name}
        ...
        <FormControl className={classes.formControlSide} variant="outlined">
          <FormHelperText className={classes.fontColor1}>
            Phone Number
          </FormHelperText>
          <ClickAwayListener onClickAway={() => setClickPhoneNum(false)}>
            <div className={classes.phoneNumDiv}>
              ...
              <div
                ...
                className={classes.countrySide2}
              >
                <Avatar src={flag} alt="logo" className={classes.flag} />
                <Typography className={classes.phoneNumText}>
                  {countryCode}
              ...
              <div
                className={clsx({
                  ...
                  [classes.phoneSide3]:
                    phoneNumValid === '' && clickPhoneNum === true,
            ...
            >
              <div
                className={clsx({
                  ...
                  [classes.inputSide3]:
                    passwordValid === '' && clickPassword === true,
          ...
          <ClickAwayListener onClickAway={() => setClickConfirmPass(false)}>
            <div
              className={clsx({
                ...
                [classes.inputSide3]:
                  confirmValid === '' && clickConfirmPass === true,
      ...
      >
        <PhoneDraw
          handleDrawClose={() => setPhoneNumberDrawOpen(false)}
          handleClickNumber={handleGetPhoneNumber}
        />
      </Drawer>
    </>
