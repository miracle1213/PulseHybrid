        ...
        <div className={classes.container}>
          ...
          <div>
            <FormControl className={classes.formControlSide} variant="outlined">
              ...
              <ClickAwayListener onClickAway={() => setClickVerifyCode(false)}>
                ...
                >
                  ...
                  {isGetCode ? (
                    ...
                    <Typography
                      className={clsx(classes.fontColor5, classes.text3)}
                    >
              ...
              <FormHelperText
                className={clsx(classes.fontColor3, classes.helperText3)}
              >
                Enter the 6 digit code sent to
                {/* {ToPhoneNumberSimplify(phoneNumber)}. */}
              </FormHelperText>
            </FormControl>
          </div>
          <button className={classes.securityBtn}>
          ...
          <div style={{ paddingTop: '20px' }}>
            <button
              className={clsx({
                ...
                [classes.registerBtn3]:
                  verifyCode.length < 6 || verifyCode.length > 6,
              })}
