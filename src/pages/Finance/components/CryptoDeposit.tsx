...
export default function FiatDeposit(props: any) {
  ...
  const [unit, setUnit] = useState<string>('ZNX')
      ...
      <Paper className={classes.caddress} variant="outlined">
        {/* <Grid container style={{ width: '100%' }}>
          <Grid
            ...
            sm={3}
            xs={12}
            style={{ textAlignLast: 'center', marginTop: '12px' }}
          >
            {!address ||
            !addresses ||
            addresses[address] === '' ||
          ...
          <Grid item sm={9} xs={12} style={{ alignSelf: 'center' }}>
            <span style={{ wordBreak: 'break-word' }}>
              ...
              addresses[address] === undefined ? (
                ...
                <span>
                  {addresses[address]}&nbsp;
                  <span
                    onClick={() => handleCopyCode(addresses[address])}
                    style={{ fontSize: '16px' }}
                  >
            ...
            <span style={{ fontSize: '12px' }}>
              Here is your wallet address, please send your {unit} to this
              address:
            </span>
          </Grid>
        </Grid> */}
